 ...
 * contract" in docs/PRD.md. Field names are snake_case because that is what we ask
...
/**
 * The verdict the pipeline produces. Maps onto the `verdicts` table in docs/PRD.md
